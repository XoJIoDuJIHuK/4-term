...
insert into FACULTY   (FACULTY,   FACULTY_NAME )
            values  ('ИДиП',     'Факультет Ияне Дзнаючто иэто Птакое');
...
insert into  TEACHER    (TEACHER,  TEACHER_NAME, GENDER, PULPIT )
                       values  ('ДТК',     'Дятко Александр Аркадьевич', 'м', 'ЛКиП');
insert into  TEACHER    (TEACHER,  TEACHER_NAME, GENDER, PULPIT )
...
insert into  TEACHER    (TEACHER,  TEACHER_NAME, GENDER, PULPIT )
             values  ('БРТШВЧ',   'Барташевич Святослав Александрович', 'м','ЛКиП');
insert into  TEACHER    (TEACHER,  TEACHER_NAME, GENDER, PULPIT )
                       values  ('АРС',     'Арсентьев Виталий Арсентьевич', 'м', 'ЛКиП');                       
insert into  TEACHER    (TEACHER,  TEACHER_NAME, GENDER, PULPIT )
...
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME,  PULPIT )
           values ('ПМАПЛ',   'Полиграф. машины, автоматы и поточные линии', 'ЛКиП');
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME,  PULPIT )
                       values ('КМС',     'Компьютерные мультимедийные системы', 'ИСиТ');
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME, PULPIT )
                       values ('ОПП',     'Организация полиграф. производства', 'ЛКиП');
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME, PULPIT)
...
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME, PULPIT )
                       values ('БЛЗиПсOO','Биология лесных зверей и птиц с осн. охотов.','ЛКиП')
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME, PULPIT )
...
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME,PULPIT )
                       values ('ТРИ',    'Технология резиновых изделий','ЛКиП') 
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME, PULPIT )
...
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME, PULPIT )
                       values ('ПЭХ',    'Прикладная электрохимия','ЛКиП')                                                                                                                                                           
